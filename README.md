...
- [x] [Get in a Googley Mood](#get-in-a-googley-mood)
- [x] [Did I Get the Job?](#did-i-get-the-job)
- [x] [Follow Along with Me](#follow-along-with-me)
- [x] [Don't feel you aren't smart enough](#dont-feel-you-arent-smart-enough)
- [x] [About Google](#about-google)
...
- [x] [Even More Knowledge](#even-more-knowledge)
    ...
    - [x] [Implement system routines](#implement-system-routines)
...
- [x] [Additional Books](#additional-books)
- [x] [Additional Learning](#additional-learning)
    - [x] [Compilers](#compilers)
    - [x] [Floating Point Numbers](#floating-point-numbers)
    - [x] [Unicode](#unicode)
    - [x] [Endianness](#endianness)
    - [x] [Emacs and vi(m)](#emacs-and-vim)
    - [x] [Unix command line tools](#unix-command-line-tools)
    - [x] [Information theory](#information-theory)
    - [x] [Parity & Hamming Code](#parity--hamming-code)
    - [x] [Entropy](#entropy)
    - [x] [Cryptography](#cryptography)
    - [x] [Compression](#compression)
    - [x] [Networking](#networking) (if you have networking experience or want to be a systems engineer, expect questions)
    - [x] [Computer Security](#computer-security)
    - [x] [Garbage collection](#garbage-collection)
    - [x] [Parallel Programming](#parallel-programming)
    - [x] [Messaging, Serialization, and Queueing Systems](#messaging-serialization-and-queueing-systems)
    - [x] [Fast Fourier Transform](#fast-fourier-transform)
    - [x] [Bloom Filter](#bloom-filter)
    - [x] [HyperLogLog](#hyperloglog)
    - [x] [Locality-Sensitive Hashing](#locality-sensitive-hashing)
    - [x] [van Emde Boas Trees](#van-emde-boas-trees)
    - [x] [Augmented Data Structures](#augmented-data-structures)
    - [x] [Tries](#tries)
    - [x] [N-ary (K-ary, M-ary) trees](#n-ary-k-ary-m-ary-trees)
    - [x] [Balanced search trees](#balanced-search-trees)
        - [x] AVL trees
        - [x] Splay trees
        - [x] Red/black trees
        - [x] 2-3 search trees
        ...
        - [x] B-Trees
    - [x] [k-D Trees](#k-d-trees)
    - [x] [Skip lists](#skip-lists)
    - [x] [Network Flows](#network-flows)
    - [x] [Disjoint Sets & Union Find](#disjoint-sets--union-find)
    - [x] [Math for Fast Processing](#math-for-fast-processing)
    - [x] [Treap](#treap)
    - [x] [Linear Programming](#linear-programming)
    - [x] [Geometry, Convex hull](#geometry-convex-hull)
    - [x] [Discrete math](#discrete-math)
    - [x] [Machine Learning](#machine-learning)
    - [x] [Go](#go)
- [x] [Additional Detail on Some Subjects](#additional-detail-on-some-subjects)
- [x] [Video Series](#video-series)
- [x] [Computer Science Courses](#computer-science-courses)
